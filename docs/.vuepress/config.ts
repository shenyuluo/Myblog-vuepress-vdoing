...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'shenyuluo/Myblog-vuepress-vdoing', // 导航栏右侧生成Github链接
    ...
    author: {
      name: '荆歌', // 必需
      link: 'https://github.com/shenyuluo', // 可选的
    },
    ...
    social: {
      ...
      icons: [
        ...
        },
        {
          ...
          title: '语雀',
          link: 'https://www.yuque.com/shenzian',
        },
      ],
    },
    ...
    footer: {
      ...
      copyrightInfo:
        '荆歌 | <a href="https://www.yuque.com/shenzian" target="_blank">语雀主页</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
  ...
  plugins: <UserPlugins>[
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: '30bc764c7fa64cc57a4f',
          clientSecret: '2234711062172ce8f8c91e942cb49d869a8bee0d',
          repo: 'blog', // GitHub 仓库
          owner: 'shenyuluo', // GitHub仓库所有者
          admin: ['shenyuluo'], // 对仓库有写权限的人
